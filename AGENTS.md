...
| **[`docs/lessons_ledger.md`](docs/lessons_ledger.md)** | **经验台账（冻结版）**：14 条被推翻的结论 + 10 类读数病理 + 8 道检测闸门 + R14 参数位移指纹（论文 Table 1 + 附录底稿）；**不引入新数字**，数字全部指向证据文件 | **已冻结（2026-09-13）**；新增经验只追加、被推翻的保留标注 |
...
| **经验台账 / 论文计划**（14 次结论推翻、10 类读数病理、8 道检测闸门、R14 指纹、大纲与停止规则） | [`docs/lessons_ledger.md`](docs/lessons_ledger.md)、[`docs/paper_outline_2026-09-13.md`](docs/paper_outline_2026-09-13.md) |
| **信息侧天花板检验**（预注册 + 修订 3/4/5 → 判读：**形式判决 P0**，三道对照支持 V3 = P3） | [`docs/pomdp_ceiling_prereg_2026-09-13.md`](docs/pomdp_ceiling_prereg_2026-09-13.md)、[`docs/pomdp_ceiling_verdict_2026-09-13.md`](docs/pomdp_ceiling_verdict_2026-09-13.md) |
