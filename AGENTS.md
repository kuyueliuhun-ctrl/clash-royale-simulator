...
| **奖励结算 v3 / 逐帧打分两提案的既有判决 + 逐帧归因提案评审** ★（**原先未被本文件索引**）：E-A/E-B ≈恒等（≤1.5%·std A）、在线状态基线 ≤**+0.0344**、段级无机制（lag-1 .987）、「训打分器」=**不行**；新提案**效果不接受**（击杀圣水账**已在 `edw`**）、**性能陷阱** = `source=` **是语义参数**（Ronin 会开始吞法术） | [`docs/frame_credit_proposal_review_2026-09-18.md`](docs/frame_credit_proposal_review_2026-09-18.md)（+ `docs/reward_settlement_prereg_2026-09-14.md`、`docs/reward_settlement_v3_design_2026-09-14.md`） |
