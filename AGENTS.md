...
| **价值通路逐层线性可读性阶梯**（预注册 + 只读探针：`fused→pre_ln→relu_ln→post_ln→mlp0_post→value` 哪一层掉到 EV≈0） | [`docs/value_ln_probe_prereg_2026-09-14.md`](docs/value_ln_probe_prereg_2026-09-14.md)、`scripts/probe_value_ln.py` |
