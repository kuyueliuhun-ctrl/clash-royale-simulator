...
# T2-3：判定语义（僵局早停参数 / 塔血合计 / timeout_winner / settle_stall* / _stall_probe）
# 已搬到 `rl/league_rules.py`；这里**显式 re-export** ⇒ 既有调用点一行未动。
from rl.league_rules import (  # noqa: E402,F401
    STALL_WINDOW, STALL_LIMIT, towers_hp, _min_alive_tower_pct,
    timeout_winner, settle_stall_from_counts, settle_stall, _stall_probe,
)
